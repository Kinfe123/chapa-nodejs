...
const title = "chapa-nodejs";
const description = "The official Node.js SDK for Chapa — initialize payments, verify transactions, split revenue, and manage subaccounts with full TypeScript support.";
