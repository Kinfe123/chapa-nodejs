...
const title = "NodeJS SDK for Chapa";
const description = "Accept payments in Ethiopia with the official Chapa Node.js SDK — initialize transactions, verify payments, split revenue, and manage subaccounts.";
